            ...
            <?php
                ...
                if(isset($_POST['addQuizQstn']) || isset($_POST['quizQstnAdded'])) {
                    echo '<form class="form-signin w-100 m-auto" id="addQuizQstn" method="post" action="educatorQuizQstn.php" enctype="multipart/form-data">';
                        ...
                        echo '</div>';
                        echo '<div class="form-floating">';
                            echo "<br><textarea name='quiz_qstn' placeholder='Quiz Question' form='addQuizQstn' cols='25' rows='3' required></textarea>";
                        echo '</div>';
                        echo '<div class="form-floating">';
                            echo "<br><textarea name='opt_a' placeholder='Option A' form='addQuizQstn' cols='25' rows='3' required></textarea>";
                        echo '</div>';
                        echo '<div class="form-floating">';
                            echo "<br><textarea name='opt_b' placeholder='Option B' form='addQuizQstn' cols='25' rows='3' required></textarea>";
                        echo '</div>';
                        echo '<div class="form-floating">';
                            echo "<br><textarea name='opt_c' placeholder='Option C' form='addQuizQstn' cols='25' rows='3' required></textarea>";
                        echo '</div>';
                        echo '<div class="form-floating">';
                            echo "<br><textarea name='opt_d' placeholder='Option D' form='addQuizQstn' cols='25' rows='3' required></textarea>";
                        echo '</div>';
                        echo "<br>";
